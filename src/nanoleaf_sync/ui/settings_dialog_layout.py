...
class SettingsDialogLayoutMixin:
    ...
    def _build_fine_tuning_section(self, QGroupBox, QGridLayout, QLabel):
        ...
        resp_grid.addWidget(QLabel("Quality"), 0, 0)
        resp_grid.addWidget(self.sampling_quality_combo, 0, 1)
        resp_grid.addWidget(self.sampling_quality_value, 0, 2)
        resp_grid.addWidget(QLabel("Target capture/output FPS"), 1, 0)
        resp_grid.addWidget(self.fps_slider, 1, 1)
        resp_grid.addWidget(self.fps_value, 1, 2)
        resp_grid.addWidget(QLabel("Smoothing"), 2, 0)
        resp_grid.addWidget(self.smoothing_slider, 2, 1)
        resp_grid.addWidget(self.smoothing_value, 2, 2)
        resp_grid.addWidget(QLabel("Smoothing speed"), 3, 0)
        resp_grid.addWidget(self.smoothing_speed_slider, 3, 1)
        resp_grid.addWidget(self.smoothing_speed_value, 3, 2)
        ...
        perf_grid.addWidget(QLabel("Performance profile"), 0, 0)
        perf_grid.addWidget(self.performance_profile_combo, 0, 1, 1, 2)
        perf_grid.addWidget(QLabel("Performance priority"), 1, 0)
        perf_grid.addWidget(self.performance_priority_combo, 1, 1, 1, 2)
