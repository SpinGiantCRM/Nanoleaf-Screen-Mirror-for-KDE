...
PERFORMANCE_PROFILE_LABELS: tuple[tuple[str, str], ...] = (
    ("Performance", PERFORMANCE_PROFILE_PERFORMANCE),
    ("Balanced", PERFORMANCE_PROFILE_BALANCED),
    ("Quality", PERFORMANCE_PROFILE_QUALITY),
)
PERFORMANCE_PROFILE_ALL_LABELS: tuple[tuple[str, str], ...] = (
    *PERFORMANCE_PROFILE_LABELS,
    ("Custom", PERFORMANCE_PROFILE_CUSTOM),
)
