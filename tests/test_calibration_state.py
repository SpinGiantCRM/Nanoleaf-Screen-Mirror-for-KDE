...
from nanoleaf_sync.runtime.zone_presets import make_horizontal_zones
...
def test_calibration_state_keeps_manual_strip_count_when_override_disabled() -> None:
    cfg = AppConfig(
    ...
    assert state.device_zone_count_source == "configured"
