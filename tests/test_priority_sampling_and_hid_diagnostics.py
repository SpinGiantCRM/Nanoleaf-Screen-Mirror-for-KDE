...
def _latency_status(*, actual_work_ms: float, hid_write_ms: float, target_fps: float = 120.0) -> dict:
    return {
        ...
        "latency_measurement": {
            ...
            "stages": {
                "loop_gap_ms": {"available": True, "median_ms": actual_work_ms, "p95_ms": actual_work_ms + 0.6, "max_ms": actual_work_ms + 1.2, "sample_count": 80},
                "pacing_wait_ms": {"available": False, "median_ms": 0.0, "p95_ms": 0.0, "max_ms": 0.0, "sample_count": 0},
                "actual_work_ms": {"available": True, "median_ms": actual_work_ms, "p95_ms": actual_work_ms + 0.5, "max_ms": actual_work_ms + 1.0, "sample_count": 80},
                "capture_wait_ms": {"available": True, "median_ms": 0.2, "p95_ms": 0.5, "max_ms": 0.8, "sample_count": 80},
                "capture_call_ms": {"available": True, "median_ms": 0.2, "p95_ms": 0.5, "max_ms": 0.8, "sample_count": 80},
                "capture_worker_loop_gap_ms": {"available": True, "median_ms": actual_work_ms, "p95_ms": actual_work_ms + 0.6, "max_ms": actual_work_ms + 1.2, "sample_count": 80},
                "capture_success_interval_ms": {"available": True, "median_ms": actual_work_ms, "p95_ms": actual_work_ms + 0.6, "max_ms": actual_work_ms + 1.2, "sample_count": 80},
                "frame_handoff_wait_ms": {"available": True, "median_ms": 0.0, "p95_ms": 0.1, "max_ms": 0.2, "sample_count": 80},
                "pending_frame_age_ms": {"available": True, "median_ms": 0.1, "p95_ms": 0.2, "max_ms": 0.4, "sample_count": 80},
                "frame_processing_ms": {"available": True, "median_ms": 10.9, "p95_ms": 11.5, "max_ms": 12.0, "sample_count": 80},
                "frame_convert_ms": {"available": True, "median_ms": 0.2, "p95_ms": 0.3, "max_ms": 0.5, "sample_count": 80},
                "zone_sampling_ms": {"available": True, "median_ms": 7.0, "p95_ms": 7.7, "max_ms": 8.1, "sample_count": 80},
                "colour_processing_ms": {"available": True, "median_ms": 0.1, "p95_ms": 0.2, "max_ms": 0.3, "sample_count": 80},
                "smoothing_ms": {"available": True, "median_ms": 0.1, "p95_ms": 0.2, "max_ms": 0.3, "sample_count": 80},
                "led_calibration_ms": {"available": True, "median_ms": 0.1, "p95_ms": 0.2, "max_ms": 0.3, "sample_count": 80},
                "output_prepare_ms": {"available": True, "median_ms": 0.1, "p95_ms": 0.2, "max_ms": 0.3, "sample_count": 80},
                "hid_write_ms": {"available": True, "median_ms": hid_write_ms, "p95_ms": hid_write_ms + 0.3, "max_ms": hid_write_ms + 0.6, "sample_count": 80},
                "hid_frame_build_ms": {"available": True, "median_ms": 0.25, "p95_ms": 0.35, "max_ms": 0.6, "sample_count": 80},
                "hid_device_write_ms": {"available": True, "median_ms": hid_write_ms, "p95_ms": hid_write_ms + 0.3, "max_ms": hid_write_ms + 0.6, "sample_count": 80},
                "hid_flush_or_wait_ms": {"available": False, "median_ms": 0.0, "p95_ms": 0.0, "max_ms": 0.0, "sample_count": 0},
                "inferred_unattributed_gap_ms": {"available": True, "median_ms": 0.0, "p95_ms": 0.1, "max_ms": 0.2, "sample_count": 80},
            },
            "counters": {"no_pending_frame_ticks": 0, "capture_worker_error_count": 0},
            "flags": {"capture_worker_active": True},
            "labels": {"latest_capture_backend_name": "kwin-dbus", "hid_device_write_limited": "yes"},
        },
    }
...
def test_priority_modes_map_to_expected_targets(monkeypatch) -> None:
    ...
    assert calls == []
    apply_process_priority(config=AppConfig(performance_priority="high"), state=state)
    apply_process_priority(config=AppConfig(performance_priority="very_high_experimental"), state=state)
    assert calls[-2:] == [-5, -10]
...
def test_latency_diagnostics_recommend_60_and_warn_120_over_budget() -> None:
    ...
    assert any("60 FPS is near target but currently slightly over budget." in line for line in lines)
