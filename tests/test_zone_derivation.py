...
from nanoleaf_sync.runtime.zone_derivation import derive_source_zones, effective_zone_count
...
def test_effective_zone_count_uses_device_count_then_detected_then_default() -> None:
    ...
    assert effective_zone_count(config=AppConfig(zones=[], device_zone_count=0), detected_device_zone_count=None) == 8
