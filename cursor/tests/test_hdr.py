...
def test_hdr_conversion_contract_zero_is_zero() -> None:
    ...
    out = convert_frame_to_srgb8(img, metadata={"transfer": "srgb", "primaries": "bt709", "max_nits": 1000.0})
...
def test_hdr_conversion_supports_pq_transfer() -> None:
    ...
    out = convert_frame_to_srgb8(img, metadata={"transfer": "pq", "primaries": "bt2020", "max_nits": 1000.0})
    assert np.array_equal(out, np.zeros_like(out))
